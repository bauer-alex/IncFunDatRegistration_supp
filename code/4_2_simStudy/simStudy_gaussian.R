...
if (!checkmate::test_directory_exists("results_registry_gaussian")) {
  reg <- makeExperimentRegistry(file.dir = "results_registry_gaussian",
                                packages = c("registr"),
                                seed     = 2020)
}

reg <- loadRegistry("results_registry_gaussian", writeable = TRUE)
